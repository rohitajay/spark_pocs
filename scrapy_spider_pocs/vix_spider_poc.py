...
if __name__ == '__main__':
    ...
    kafka_config = {'servers': ['localhost:9092'],
                    'topics': ['vix', 'volume', 'cot', 'ind', 'deep', 'predict_timestamp', 'prediction']}
    ...
    event_list = ['Crude Oil Inventories', 'ISM Non-Manufacturing PMI', 'ISM Non-Manufacturing Employment',
                  'Services PMI', 'ADP Nonfarm Employment Change', 'Core CPI', 'Fed Interest Rate Decision',
                  'Building Permits',
    ...
    economic_data = {'countries': ['United States'], 'importance': ['1', '2', '3'], 'event_list': event_list,
                     'cot': 'S&P 500 STOCK INDEX'}

    print("let kafka work")
    run_indicator_spider(countries= economic_data['countries'], importance= '1',event_list=event_list,current_dt=datetime.now(),
                         server=kafka_config['servers'], topic= 'vix')

    print('Kafka running now')
    pass
